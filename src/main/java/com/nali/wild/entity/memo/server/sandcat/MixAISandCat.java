...
public class MixAISandCat<SD extends ISoundLe, BD extends BothDaSandCat<SD>, E extends EntityLeInv, I extends IMixLe<SD, BD, E>, S extends ServerSleInv<SD, BD, E, I, ?>> extends MixAIEInv<SD, BD, E, I, S>
{
