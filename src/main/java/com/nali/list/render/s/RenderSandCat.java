...
public class RenderSandCat<E extends EntityLivingBase, I extends IMixLe<SD, BD, E>, MB extends MixBoxSle<RG, RS, RC, RST, ?, SD, BD, E, I, MR, C>, MR extends MixRenderE<RG, RS, RC, RST, ?, SD, BD, E, I, MB, C>, C extends ClientSle<RG, RS, RC, RST, ?, SD, BD, E, I, MB, MR>, SD extends ISoundDaLe, BD extends IBothDaNe & IBothDaSn, RG extends MemoGs, RS extends MemoSs, RST extends StoreS<RG, RS>, RC extends IClientDaS> extends WildRenderSe<E, I, MB, MR, C, SD, BD, RG, RS, RST, RC>
{
...
//    public static BothData BOTHDATA = WildSandCat.BOTHDATA;
    ...
    {
        this((RST)I.clientloader.stores, (RC)ClientDaSandCat.ICLIENTDAS, (BD)BothDaSandCat.IBOTHDASN);
    }

    public RenderSandCat(RST rst, RC rc, BD bd)
    {
        super(rst, rc, bd);
