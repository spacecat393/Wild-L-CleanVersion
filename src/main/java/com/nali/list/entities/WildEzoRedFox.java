...
public class WildEzoRedFox extends SkinningEntities
{
    ...
    public void createServer()
    {
        ...
        this.server_skinningentitiesliveframe_array[0].condition_boolean_supplier_array = new Supplier[]
        {
            ...
            () -> this.server_skinningentitiesliveframe_array[0].setTLoop(13, this.main_server_work_byte_array[this.skinningentitiesbytes.ATTACK()] == 1 && this.moveForward != 0),
            ...
            () -> this.server_skinningentitiesliveframe_array[0].setFLoopFree(11, this.skinningentitiesbytes.ON_PAT(), this.server_work_byte_array[this.skinningentitiesbytes.ON_PAT()] == 1),
